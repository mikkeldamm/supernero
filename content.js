(async () => {
    ...
    function renderVoucherCreateButtonsInBank() {
        [...document.querySelectorAll('.reconciliation-item')].forEach((_element) => {
            ...
            const titleElement = _element.querySelector('.reconciliation-item-description');
            const dateElement = _element.querySelector('.reconciliation-item-date');
            const amountElement = _element.querySelector('.reconciliation-item-amount');
            ...
            _element.appendChild(createNodeForCreateButton({ date, amount, title }));
        });
    }

    function createNodeForCreateButton({ date, amount, title }) {
